...
strings["en"] = {
    ...
    dossierNumber: "Dossier {0}",
    uploadedDate: "Uploaded on {0}",
    refusedDate: "Refused on {0}, to recharge",
    refusedDateAndReason: "Refused on {0}, reason: \"{1}\". To recharge",
    ...
    closingDocumentation: "Closing documentation",
    typology: "Typology",
    noModel: "No model",
    selfCompiledDownloadableTemplate: "Self-compiled downloadable template",
    uploadDocument: "Upload document",
    refuse: "Refuse",
    refuseReasonDescription: "Refuse reason (optional)",
    refuseDocument: "Refuse document",
    deleteAttachment: "Delete attachment",
    downloadTemplate: "Download template",
    downloadEmptyTemplate: "Download template (empty)",
    ...
    payOff: "Pay off",
    refused: "Refused",
    rowsDescription: "{0} of {1}",
    refusedRows: "{0} refused",
    fabricatorDocumentation: "Fabricator documentation",
    valueInBill: "Value in bill",
...
strings["it"] = {
    ...
    refusedDateAndReason: "Rifiutato il {0}, motivazione: \"{1}\". Da ricaricare",
    ...
    downloadEmptyTemplate: "Scarica template (vuoto)",
